...
ENGINE_CHAIN_MAP: Dict[str, List[str]] = {
    ...
    'opensource':  ['oss-finder', 'tavily', 'open-websearch'],
    'community':   ['agent-reach', 'last30days', 'tavily'],
    'docs':        ['context7', 'defuddle', 'firecrawl'],
    'news':        ['last30days', 'tavily', 'websearch'],
    'general':     ['tavily', 'open-websearch', 'websearch'],
    'definition':  ['tavily', 'websearch', 'defuddle'],
    'guide':       ['tavily', 'context7', 'defuddle'],
    'comparison':  ['tavily', 'agent-reach', 'arxiv'],
}
