# Deep Research Ultra — 超级深度调研工具 v6.10
...
[![Version](https://img.shields.io/badge/version-6.10.0-brightgreen.svg)]()
...
*v6.10 · 2026-09-20 · 四阶段范式 + Lead 内联编排 + 引擎功能自检 + Phase 0 环境闸门（不足即硬停并引导配置）+ 文件化交付契约 + 两档 verified 判据（跨域三角 / 一手反查）+ 发布门按引用-证据对齐判定；更新历史见 CHANGELOG.md*
