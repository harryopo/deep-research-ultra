...
**已修 11 条**（1、2、4、6、7、9、10、11、12、13、16），**部分处理 3 条**（3 只补了文档口径、
...
**测试**：新增 `tests/test_v615_dogfood.py` 25 项（重填已有 URL 不升级、arXiv 四种表示算同一制品、
