...
**已修 12 条**（1、2、4、6、7、9、10、11、12、13、15、16），**部分处理 3 条**（3 只补了文档口径、
5 只补了"缺依赖看得见"+ 文档更正、14 已离线复测定位（见 ⑭），剩下的是引擎侧取证），
...
**测试**：新增 `tests/test_v615_dogfood.py` 27 项（重填已有 URL 不升级、arXiv 四种表示算同一制品、
